...
static struct my_option	my_long_options[] = {{"in_file", 'F', "Input file",
		&INFILE, &INFILE, nullptr, GET_STR, REQUIRED_ARG, 0, 0, 0, nullptr, 0,
		nullptr}, {"out_file", 'O', "Output filename (mysqlclient_ername.h)",
		&OUTFILE, &OUTFILE, nullptr, GET_STR, REQUIRED_ARG, 0, 0, 0, nullptr, 0,
		nullptr}, {nullptr, 0, nullptr, nullptr, nullptr, nullptr, GET_NO_ARG,
		...
		if (is_prefix(str, "#define"))
		{
			...
			*/
			...
			for (char *err = my_strtok_r(str, " \n\t",
					&last_token); err != nullptr; err = my_strtok_r(nullptr,
					" \n\t", &last_token))
			{
				if (count == 0)
